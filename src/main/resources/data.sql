...
INSERT INTO users (id,name, email,phone, password, profile_image,role, student) VALUES (1,'user1', 'user1@cool.fr','01010101', '1111', 'photo1',0, 1);
INSERT INTO users (id,name, email,phone, password, profile_image,role,student) VALUES (2,'user2', 'user2@cool.fr','02020202', '2222', 'photo2',1, 2);
INSERT INTO users (id,name, email,phone, password, profile_image,role, student) VALUES (3,'user3', 'user3@cool.fr','03030303', '3333', 'photo3',0, 3);
INSERT INTO users (id,name, email,phone, password, profile_image,role,student) VALUES (4,'user4', 'user4@cool.fr','04040404', '4444', 'photo4',1, 4);
