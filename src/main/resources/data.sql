...
--INSERT INTO users (name, email,phone, profile_image) VALUES ('user1', 'usero@cool.fr','01010101010', 'photo1');
--INSERT INTO users (name, email,phone, profile_image) VALUES ('user2', 'usert@cool.fr','02020202020', 'photo2');
--INSERT INTO users (name, email,phone, profile_image) VALUES ('user3', 'usertr@cool.fr','03030303030', 'photo3');
--INSERT INTO users (name, email,phone, profile_image) VALUES ('user4', 'userfr@cool.fr','04040404040', 'photo4');
